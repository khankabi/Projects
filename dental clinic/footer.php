...
<body>
    <footer class="pt-3 pb-0 mb-0 text-light bg-dark text-center" style="font-family: 'Ubuntu', sans-serif;">
        <!-- <h3>Some important things about us that you should know</h3> -->
        <!-- <hr> -->
        <marquee class="text-large" style="font-family:ubuntu"> OFFICE HOURS : Monday to Saturday 10:30AM to 2PM ||
            5:30PM
            to 8:30PM
        </marquee>
        <hr>
        <div class="row container text-center">
            <div class="col">
                <img src="images/LOGO.webp" width="100" height="90" class="d-inline-block align-top"
                    alt="here is my logo">
                <span>
            ...
            <div id="reachus" class="col col-lg-2 mt-5">
